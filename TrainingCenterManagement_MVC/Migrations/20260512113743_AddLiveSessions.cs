        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JitsiRoomName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveSessions", x => x.LiveSessionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_LiveSessions_JitsiRoomName",
                table: "LiveSessions",
                column: "JitsiRoomName",
                unique: true);
        }
